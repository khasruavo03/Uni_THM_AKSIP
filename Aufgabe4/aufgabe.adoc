...
1. link:{includedir}call-ret[Hier] ist eine Diskussion der Instruktionen zum Unterprogrammaufruf und in <<a4_instructions>> eine Liste aller Instruktionen der VM dieser Version.
...
7. Der zu dieser Aufgabenstellung gehörende Assemblesr ist natürlich auch verfügbar: link:{includedir}nja[nja]
